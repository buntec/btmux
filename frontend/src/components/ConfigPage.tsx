...
function initialDraft(config: ClientConfig): Draft {
  return {
    ...
    allowTransparency: config.terminal.allowTransparency ?? false,
...
function toToml(draft: Draft): string {
  ...
  const lines = [
    '# Settings generated by btmux /config',
    ...
    <main className="relative h-full overflow-y-auto bg-transparent text-foreground">
        ...
        <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-8">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="hidden min-w-0 sm:block">
              ...
              <p className="truncate text-xs text-muted-foreground">Live session preview · esc/q to close</p>
            </div>
          </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-8 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.8fr)] lg:px-8">
        <Tabs defaultValue="general" className="min-w-0">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 xl:grid-cols-7">
              ...
              <FieldSet>
                ...
                <FieldGroup>
                  ...
                  <Field orientation="horizontal">
                    ...
                    <Switch id="vi-mode" checked={draft.viMode} onCheckedChange={(value) => update('viMode', value)} />
                  </Field>
                  <Field orientation="horizontal">
                    <FieldContent>
          ...
          <TabsContent value="keybinds" className="pt-6">
            <FieldSet>
          ...
          <TabsContent value="logging" className="pt-6">
            <FieldSet>
              ...
              <FieldDescription>
                Use error, warn, info, debug, trace, or a tracing directive such as btmux=debug,tower_http=info. Changes
                are included in the copied TOML and take effect on restart.
              </FieldDescription>
              <FieldGroup>
                <Field>
