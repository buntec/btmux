// Generated by scripts/sync-radiant.mjs. Do not edit.
export const RADIANT_REVISION = 'e5d078d1b26e11224ec781ffdc9506a7faf19a4a';
export const RADIANT_SHADERS = [
  {
    id: 'flow-field',
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: 'DISTORTION_POINTS',
        label: 'Distortion Points',
        min: 1,
        max: 6,
        step: 1,
        default: 3,
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: 'ERUPTION_INTERVAL',
        label: 'Eruption Interval',
        min: 2,
        max: 15,
        step: 1,
        default: 6,
