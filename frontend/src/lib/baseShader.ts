 ...
 * cleanup paths of *transient* effects (the navigate-to glitch, the
 * session-switcher shader, the privacy pixelate): they own the post-process
 * slot temporarily and have to hand it back to whatever the base state is when
 * they finish, which may not be the one they saw when they started.
 */
